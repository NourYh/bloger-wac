...
{
    Route::get("/","Admin\CallieController@index");
    Route::get("/no-access","Admin\CallieController@noAccess");
...
Route::get('/home', 'CallieController@index')->name('home');
Route::get('/contact', 'CallieController@contact')->name('contact');
Route::get('/welcome', 'CallieController@welcome')->name('welcome');
Route::get('/articles', 'CallieController@articles')->name('home.articles');
Route::get('/article/{id}', 'CallieController@article')->name('home.article');
